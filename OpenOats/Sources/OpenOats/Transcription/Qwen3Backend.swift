...
actor QwenInterviewASRFallback {
    ...
    /// Stops only a server process that OpenOats launched. An already-running
...
private actor MLXQwenService {
    ...
    private let localKey = "openoats-local-loopback"
    ...
    func transcribe(
        ...
        let boundary = "OpenOats-\(UUID().uuidString)"
        var body = Data()
