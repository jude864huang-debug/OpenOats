...
struct InterviewWorkspaceActionBar: View {
    ...
    private var moreMenu: some View {
        Menu {
            ...
            Button("重新生成当前回答", systemImage: "arrow.clockwise") {
            ...
            Button("结束面试", systemImage: "xmark.circle", role: .destructive) {
                confirmsEndingInterview = true
            }
        } label: {
            Label("更多", systemImage: "ellipsis.circle")
                .frame(minWidth: 72, maxWidth: 72, minHeight: 44)
                .contentShape(Rectangle())
        }
        .menuStyle(.button)
        .buttonStyle(.bordered)
